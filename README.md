...
## Структура проекта
``` bash
todo-app/ # Корень проекта
├── backend/ # Логика на Go
│ ├── main.go # Точка входа backend
│ ├── models/ # Определение структур (Task и т.д.)
│ ├── services/ # Логика работы с задачами
│ └── storage/ # Сохранение состояния (файл/БД)
│
├── frontend/ # Интерфейс (JavaScript/HTML/CSS)
│ ├── public/ # Статические ресурсы
│ ├── src/ # Исходный код
│ │ ├── App.js # Главный компонент приложения
│ │ ├── components/ # Компоненты (TaskItem, TaskList, FilterPanel)
│ │ ├── pages/ # (если будут страницы)
│ │ └── styles/ # CSS/SCSS стили
│ └── package.json # NPM-зависимости
│
├── build/ # Сюда собирается готовое приложение (не пушить в git)
│
